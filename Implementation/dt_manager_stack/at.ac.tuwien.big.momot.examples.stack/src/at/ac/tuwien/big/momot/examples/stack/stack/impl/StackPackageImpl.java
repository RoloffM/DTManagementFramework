...
public class StackPackageImpl extends EPackageImpl implements StackPackage {
	...
	public static StackPackage init() {
		...
		Object registeredStackPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		StackPackageImpl theStackPackage = registeredStackPackage instanceof StackPackageImpl ? (StackPackageImpl)registeredStackPackage : new StackPackageImpl();
